...
- \bullet \nobreakspace   Software/Data Carpentries Instructor Training \hfill 2019
- \bullet \nobreakspace   Developed and teach curricula for multiple workshops
    - \bullet \nobreakspace   *Repetitive Tasks in R*
        - \bullet \nobreakspace   Adapted and expanded from Software Carpentry R lesson
    - \bullet \nobreakspace   *Visualization in R Using 'ggplot2'*
    ...
    - \bullet \nobreakspace   *Survival Skills: Concepts of Data-Driven Visualization*
    - \bullet \nobreakspace   *Survival Skills: Using Computers for Scholarly Research*
    - \bullet \nobreakspace   *Smoother Meetings: Tips from Your Librarians*
    - \bullet \nobreakspace   *A Very Short Introduction to Geospatial R*
    ...
    - \bullet \nobreakspace   *A Very Short Introduction to R*
...
- \bullet \nobreakspace   Co-developed and teach curricula for multiple workshops
    - \bullet \nobreakspace   *Survival Skills: Managing Research Files*
    - \bullet \nobreakspace   *Citation management with Zotero*
    - \bullet \nobreakspace   *Managing Research Projects with OSF*
    - \bullet \nobreakspace   *Survival Skills: Troubleshooting Computer Code*
- \bullet \nobreakspace   Maintain and update workshops in collaboration with colleagues
    - \bullet \nobreakspace   *Formatting Your Data for Analysis*
        - \bullet \nobreakspace   Adapted and shortened from Data Carpentry "tidy data" lesson
- \bullet \nobreakspace   Instructing from existing curricula
    - \bullet \nobreakspace   *R for Scientific Programming (Software Carpentry lesson)*
    - \bullet \nobreakspace   *Data Analysis and Visualisation in R for Ecologists (Data Carpentry lesson)*
        - \bullet \nobreakspace   Including modifications for 1.25-2.5 hr short version for course instruction
    - \bullet \nobreakspace   *R for Social Sciences (Data Carpentry lesson)*
    - \bullet \nobreakspace  *Introduction to R for Geospatial Data (Data Carpentry lesson)*
    - \bullet \nobreakspace   *Data Organization in Spreadsheets for Ecologists (Data Carpentry lesson)*
    - \bullet \nobreakspace   *Data Management with SQL for Ecologists (Data Carpentry lesson)*
    - \bullet \nobreakspace   *Tracking Changes with Version Control in Git/GitHub (Software Carpentry lesson)*
        - \bullet \nobreakspace   Including modifications for 2.5 hr two-session shorter version
    - \bullet \nobreakspace   *Unix Shell (Bash) for Beginners (Software Carpentry lesson)*
- \bullet \nobreakspace   Helping from existing curricula
    - \bullet \nobreakspace   All lessons above
    - \bullet \nobreakspace   *Data Cleaning with OpenRefine for Ecologists (Data Carpentry lesson)*
    - \bullet \nobreakspace   *Python (Software Carpentry lesson)*
...
- \bullet \nobreakspace  *Information literacy for STEM courses*
...
- \bullet \nobreakspace *Introduction to library resources/ OU Libraries welcome presentations*
...
- *Collection Management*
  - \bullet \nobreakspace Determining need for library program assessments
  - \bullet \nobreakspace Approving book purchase requests from my subject areas
...
- \bullet \nobreakspace Ahmed Sharaf \hfill August 2022-August 2023
    - \bullet \nobreakspace   Undergraduate student web developer. professional skills like note taking, working with consultants, writing short project updates, creating and implementing project milestones, collaborative use of GitHub. Graduated December 2023.
- \bullet \nobreakspace   Henry Dang (2017-2018)
...
- \bullet \nobreakspace   Field technicians (3) \hfill summer 2015
...
- Ms. Karie Antell
  ...
  - Head of Library Instruction and Liaison Services
...
- Ms. Sarah Robbins
  ...
  - Senior Director, Strategic & Research Initiatives
    - University of Oklahoma Libraries
    - 401 W. Brooks St.
    - Norman, OK, USA 73019
- Dr. Michael A. Patten
